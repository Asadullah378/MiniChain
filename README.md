...
- 🚀 [Quick Start](#quick-start)
  ...
  - 🛠️ [Setup (Run once on each VM)](#2-setup-run-once-on-each-vm)
  - 🤝 [Configure Peers](#3-configure-peers)
  - ▶️ [Start Node](#4-start-node-run-on-each-vm)
  - 🖥️ [Run Frontend (Vite React)](#5-run-frontend-vite-react)

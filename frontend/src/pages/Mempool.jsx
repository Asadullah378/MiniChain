    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Transaction Form - Moved to Left/Top for visibility */}
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sticky top-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1.5">Sender Address</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1.5">Recipient Address</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1.5">Amount (MC)</label>
